...
export const BUILDINGS: Record<string, BuildingDef> = {
  ...
  condenser: {
    ...
    tier: 0,
    attack: 0,
    desc: "Wrings moisture from the ash haze. +3💧/turn (+4 more on a geothermal vent).",
  },
  servers: {
    kind: "servers",
    name: "Server Rack",
    ...
    tier: 0,
    attack: 0,
    desc: "The true crown jewels. +3▣/turn, drinks 2⚡ and 2💧/turn. Protect at all costs.",
  },
  reactor: {
    kind: "reactor",
    name: "Fusion Reactor",
    ...
    tier: 2,
    attack: 0,
    desc: "+10⚡/turn (+5 more on a geothermal vent), needs 1💧 to cool. Ten years away, finally arrived.",
  },
  mechworks: {
    kind: "mechworks",
    name: "Mech Works",
...
export const ADVISOR = {
  ...
  overheat: [
    "Advisor: The reservoir is dry and the cores are throttling. The model's last coherent output was the word 'thirsty', repeated.",
    "Advisor: No coolant. The server hall is now a kiln with opinions. Compute has stopped until it drinks.",
    "Advisor: We are out of water. I have informed the peasants that their ration was a rounding error in a very important datacenter.",
  ],
};
